...
public class SensitiveFormatter implements Formatter<String> {
    ...
    public SensitiveFormatter(SensitiveCallback callback) {
    ...
    public String parse(String s, Locale locale) throws ParseException {
        ...
        System.out.println(">>>>>在具体项目中实现类" + SensitiveCallback.class.getSimpleName() + ">>>回调做过滤处理");
        return callback.filter(s);
    }
