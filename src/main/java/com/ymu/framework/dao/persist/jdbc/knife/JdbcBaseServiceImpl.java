...
public abstract class JdbcBaseServiceImpl<T extends Serializable> implements IJdbcBaseService<T> {

	@Autowired
	private IJdbcBaseDao<T> basedao; // 泛型依赖注入

	public IJdbcBaseDao<T> getBaseDao() {
		return basedao;
	}
