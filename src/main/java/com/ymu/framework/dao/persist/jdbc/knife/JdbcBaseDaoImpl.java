package com.ymu.framework.dao.persist.jdbc.knife;
 ...
 * 
 */
public abstract class JdbcBaseDaoImpl<T extends Serializable> implements IJdbcBaseDao<T> {

	private static final Logger logger = LoggerFactory.getLogger(JdbcBaseDaoImpl.class);
