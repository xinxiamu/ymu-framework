...
import com.ymu.framework.utils.AssertUtil;
...
public final class Insert {
	...
	/*
	 * public static void main(String[] args) { Object[] rowValues = new
	 * Object[] { "张", 3, 4F, 5D, new Date(), true, false };
	 * 
	 * System.out.println(generateInsertValue(rowValues));
	 * 
	 * List<Object[]> list = new ArrayList<>(); for (int i = 0; i < 10; i++) {
	 * list.add(rowValues); }
	 * System.out.println(generateInsertValueBatch(list));
	 * 
	 * String[] fields = new String[] { "username", "age", "cars", "house",
	 * "bornDate", "man", "woman" };
	...
	public static String generateInsertSql(String tableName, final String[] fields, final List<Object[]> rowBatch) {
		...
		StringBuilder sb = new StringBuilder("INSERT INTO ").append(StringUtil.javaFieldName2SqlFieldName(tableName))
				.append("(");
		for (int i = 0; i < fields.length; i++) {
			String field = StringUtil.javaFieldName2SqlFieldName(fields[i]);
			sb.append(field);
